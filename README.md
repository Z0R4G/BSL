...
### Root Route (`/`)
![Screenshot of the / route in browser](my-bsl-http-server/documentation/Picture1.png)

### About Route (`/about`)
![Screenshot of the /about route in browser](my-bsl-http-server/documentation/Picture2.png)

### 404 Error Page
![Screenshot of any unknown route showing the 404 error page](my-bsl-http-server/documentation/Picture3.png)

### Terminal Running Server
![Screenshot of the terminal running the server](my-bsl-http-server/documentation/image.png)
